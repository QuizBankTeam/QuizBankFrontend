...
//        Based on the position of the recycler view
        ...
        holder.tv_BankType.text = bankModels[position].bankType
...
//            tv_BankImage = itemView.findViewById(R.id.bank_image);
            tv_BankName = itemView.findViewById(R.id.bank_title)
            tv_BankType = itemView.findViewById(R.id.bank_type)
            tv_BankDate = itemView.findViewById(R.id.bank_createdDate)
