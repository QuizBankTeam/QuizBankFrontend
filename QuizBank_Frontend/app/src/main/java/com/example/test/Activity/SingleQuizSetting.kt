...
import com.example.test.databinding.SpSingleQuizSettingBinding

class SingleQuizSetting: AppCompatActivity() {
    private lateinit var mpQuizSetAttrBinding: MpSingleQuizSettingBinding
    private lateinit var spQuizSetAttrBinding: SpSingleQuizSettingBinding
    ...
    private fun init(){
        ...
        if(type=="casual") {
            mpQuizSetAttrBinding = MpSingleQuizSettingBinding.inflate(layoutInflater)
        ...
        {
            spQuizSetAttrBinding = SpSingleQuizSettingBinding.inflate(layoutInflater)
