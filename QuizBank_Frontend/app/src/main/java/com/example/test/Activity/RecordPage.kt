...
import com.example.test.Adapter.RecordPageAdapter
import com.example.test.databinding.RecordPageBinding
...
class RecordPage: AppCompatActivity() {
    private lateinit var recordBinding: RecordPageBinding
    private lateinit var fragmentAdapter: RecordPageAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        recordBinding = RecordPageBinding.inflate(layoutInflater)
